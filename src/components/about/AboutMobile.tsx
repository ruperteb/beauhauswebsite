...
export const AboutMobile: React.FunctionComponent<Props> = ({ }) => {
    ...
    aboutImage.resize(fill().height(imageHeight)).delivery(format(auto()))
                ...
                <StyledGridColumn width={10}>
                    ...
                    <Grid.Column style={{ display: "flex" }} width={6}>
                        <AboutTextDiv>
                            ...
                            <AboutSubHeadingTextDiv style={{ marginBottom: "4rem" }} initial={false} animate={visibility() ? "visible" : "hidden"} variants={textVariants} transition={{ duration: 1, delay: 0.2 }}>

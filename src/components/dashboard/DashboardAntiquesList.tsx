...
import AntiquesListItem from "./DashboardAntiquesListItem"
...
export const DashboardAntiquesList: React.FunctionComponent<Props> = ({ /* propertyData, search */ }) => {
  ...
  const typeFilter = useAppSelector((state) => state.dashboard.typeFilter)
  const search = useAppSelector((state) => state.dashboard.search)
...
export default DashboardAntiquesList